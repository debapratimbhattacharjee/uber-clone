          ...
          <div class="flex items-center px-4 py-5">
            ...
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
                ...
                <div class="text-xl">RS{{ calculatePrice(1, distance.value) }}</div>
              </div>
          ...
          <div class="flex items-center px-4 py-5">
            ...
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
                ...
                <div class="text-xl">RS{{ calculatePrice(1.25, distance.value) }}</div>
              </div>
              <div class="text-gray-500">{{ duration.text }}</div>
            </div>
          </div>
          ...
          <div class="flex items-center px-4 py-5">
            ...
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
                ...
                <div class="text-xl">RS{{ calculatePrice(1.5, distance.value) }}</div>
              </div>
              <div class="text-gray-500">{{ duration.text }}</div>
            </div>
          </div>
...
<script setup>
  ...
  onMounted(async () => {
    ...
    console.log('Pickup:', direction.pickup, 'Destination:', direction.destination);
    setTimeout(() => { 
      initMap() 
    }, 50)
  })
  ...
  const initMap = () => {
    ...
    const map = new window.google.maps.Map(document.getElementById("map"), {
      center: { lat: 37.7749, lng: -122.4194 }, // Replace with dynamic location
      zoom: 4,
      minZoom: 3,
      maxZoom: 17,
